...
class ParSort {
    ...
    public static void sort(int[] array, int from, int to,ForkJoinPool threads) {
    ...
    private static CompletableFuture<int[]> parsort(int[] array, int from, int to,ForkJoinPool threads) {
